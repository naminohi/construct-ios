...
public enum Shared_Proto_Sentinel_V1_SentinelService: Sendable {
    ...
    public enum Method: Sendable {
        ...
        /// Namespace for "AppealRestriction" metadata.
        public enum AppealRestriction: Sendable {
            /// Request type for "AppealRestriction".
            public typealias Input = Shared_Proto_Sentinel_V1_AppealRestrictionRequest
            /// Response type for "AppealRestriction".
            public typealias Output = Shared_Proto_Sentinel_V1_AppealRestrictionResponse
            /// Descriptor for "AppealRestriction".
            public static let descriptor = GRPCCore.MethodDescriptor(
                service: GRPCCore.ServiceDescriptor(fullyQualifiedService: "shared.proto.sentinel.v1.SentinelService"),
...
extension Shared_Proto_Sentinel_V1_SentinelService {
    ...
    public protocol ClientProtocol: Sendable {
        ...
        /// Call the "AppealRestriction" method.
        ///
        /// > Source IDL Documentation:
        /// >
        ...
        ///   - serializer: A serializer for `Shared_Proto_Sentinel_V1_AppealRestrictionRequest` messages.
        ///   - deserializer: A deserializer for `Shared_Proto_Sentinel_V1_AppealRestrictionResponse` messages.
        ///   - options: Options to apply to this RPC.
        ///   - handleResponse: A closure which handles the response, the result of which is
        ///       returned to the caller. Returning from the closure will cancel the RPC if it
        ///       hasn't already finished.
        /// - Returns: The result of `handleResponse`.
        func appealRestriction<Result>(
            request: GRPCCore.ClientRequest<Shared_Proto_Sentinel_V1_AppealRestrictionRequest>,
            serializer: some GRPCCore.MessageSerializer<Shared_Proto_Sentinel_V1_AppealRestrictionRequest>,
    ...
    public struct Client<Transport>: ClientProtocol where Transport: GRPCCore.ClientTransport {
        ...
        ///       hasn't already finished.
        /// - Returns: The result of `handleResponse`.
        public func appealRestriction<Result>(
            request: GRPCCore.ClientRequest<Shared_Proto_Sentinel_V1_AppealRestrictionRequest>,
            serializer: some GRPCCore.MessageSerializer<Shared_Proto_Sentinel_V1_AppealRestrictionRequest>,
            deserializer: some GRPCCore.MessageDeserializer<Shared_Proto_Sentinel_V1_AppealRestrictionResponse>,
            options: GRPCCore.CallOptions = .defaults,
            onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Shared_Proto_Sentinel_V1_AppealRestrictionResponse>) async throws -> Result = { response in
                try response.message
            }
        ) async throws -> Result where Result: Sendable {
            try await self.client.unary(
...
extension Shared_Proto_Sentinel_V1_SentinelService.ClientProtocol {
    ...
    public func appealRestriction<Result>(
        ...
        try await self.appealRestriction(
            request: request,
...
extension Shared_Proto_Sentinel_V1_SentinelService.ClientProtocol {
    ...
    /// - Returns: The result of `handleResponse`.
    public func appealRestriction<Result>(
        _ message: Shared_Proto_Sentinel_V1_AppealRestrictionRequest,
        metadata: GRPCCore.Metadata = [:],
        options: GRPCCore.CallOptions = .defaults,
        onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Shared_Proto_Sentinel_V1_AppealRestrictionResponse>) async throws -> Result = { response in
            try response.message
        ...
        let request = GRPCCore.ClientRequest<Shared_Proto_Sentinel_V1_AppealRestrictionRequest>(
            message: message,
            metadata: metadata
        )
